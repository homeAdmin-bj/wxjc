<template>
  <div id="StaticUser">
    <div class="static">
      <div class="title">统计分析 > 拨测用户统计</div>
      <div class="content">
        <div class="search">
...
export default {
  ...
  methods: {
    drawLine(){
      ...
      //       source: [
      //         ['product', '卫星终端', '应急联系人'],
      //         ['应急保障中心', 43.3, 85.8, 93.7],
      //         ['某某省通管局', 83.1, 73.4, 55.1],
      //         ['某某省地市局', 86.4, 65.2, 82.5],
      //         ['某某省移动公司', 72.4, 53.9, 39.1],
      //         ['某某省电信公司', 32.4, 23.9, 49.1],
      //         ['某某省联通公司', 52.4, 33.9, 29.1]
      //       ]
      //     },
      //     xAxis: {type: 'category'},
      //     yAxis: {},
      ...
      let option = {
          tooltip: {
            ...
            formatter: function (params) {
              console.log(params);
              return params[0].name + '<br/>' + '卫星终端：' + params[0].value + '<br/>' + '应急联系人：' + params[3].value;
            }
          },
          dataZoom:[
            {
          ...
          xAxis: {
              data: ['应急保障中心', '某某某通管局', '某某某地市局', '某某某移动公司', '某某某联通公司', '某某某电信公司', '某某某下属单位', '某某某应急部门'],
              axisTick: {show: false},
              axisLabel: {
                  textStyle: {
                      color: '#000'
