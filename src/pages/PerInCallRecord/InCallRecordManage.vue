<template>
  <div>
    <div v-if="flag==1" class="infor_Page">
      <p style="height:30px;line-height:30px;color:#222;font-size:12px;margin-left:10px;">应急联系人呼入管理>呼入记录查询</p> 
      <div class="pageContent tableStyle">
        ...
        <el-table
          ...
          <el-table-column
           ...
           <el-table-column
            prop="inNum"
            label="已呼入用户数" show-overflow-tooltip>
          </el-table-column>
          <el-table-column
            prop=""
            label="操作" width="120">
...
import taskInforById from "./InCallRecordManageView";
export default {
  data () {
    return {
      flag:1,
  ...
  methods: {
    ...
    search(){ //查询
      var v=this;
      https.fetchPost('/dialing/ecTaskIn/showPage',{
    ...
    toInforView(id){
      this.flag=2;
      this.taskParams={id:id,netType:1}
